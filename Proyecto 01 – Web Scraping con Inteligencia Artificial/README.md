...
Este repositorio contiene un proyecto de web scraping diseñado para extraer, procesar y almacenar información de sitios web de forma automatizada, utilizando inteligencia artificial y flujos de trabajo escalables con n8n.

El proyecto se basa en un enfoque modular y por etapas, permitiendo manejar sitios con estructuras cambiantes, protecciones anti-bot y distintos tipos de datos (estructurados y no estructurados).
...
Servicios de scraping especializados (ej. Firecrawl): Para interactuar con sitios web protegidos y evitar bloqueos comunes (403 Forbidden).
Inteligencia Artificial (OpenAI): Extracción semántica de información y refinamiento del contenido.
